...
request_access_token_1(authorization_payload arg1, authz_token_payload arg2,  CLIENT *clnt)
{
...
{
	static validate_action_response clnt_res;
...
approve_request_token_1(authz_token_payload arg1,  CLIENT *clnt)
{
	static approve_req_token_response clnt_res;

	memset((char *)&clnt_res, 0, sizeof(clnt_res));
	if (clnt_call (clnt, APPROVE_REQUEST_TOKEN,
		(xdrproc_t) xdr_authz_token_payload, (caddr_t) &arg1,
