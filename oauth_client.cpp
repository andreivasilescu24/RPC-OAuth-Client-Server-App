...
void oauth_prog_1(char *host, char *input_file_name)
{
	...
	while (std::getline(input_file, line))
	{
		...
		// **********************
		// std::cout << "TOKEN OPS REMAINING" << std::endl;
		// for (auto it = token_ops.begin(); it != token_ops.end(); it++)
		// {
		...
		else
		{
			...
			{
				if (token_ops.find(delegated_action_payload_.access_token) != token_ops.end() && strcmp(*validate_del_action_response, "PERMISSION_DENIED"))
				{
